...
pub mod updates { #[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)] #[serde(rename_all="lowercase")] pub enum UpdateChannel { Stable, Nightly, Xray } }
...
pub mod xray { #[path = "../../../../src/xray/import.rs"] pub mod import; #[path = "../../../../src/xray/nodes.rs"] pub mod nodes; #[path = "../../../../src/xray/policy.rs"] pub mod policy; pub fn default_strategy() -> crate::strategy::Strategy { crate::strategy::Strategy::default() } }
