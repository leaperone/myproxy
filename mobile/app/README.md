...
The mobile app uses Expo SDK 57.0.24, React Native 0.86.3 and React 19.2.3. Expo's SDK 57 bare template pins React Native 0.86.3. Lockfiles generated by GitHub Actions are committed so each build resolves the same dependencies. Local work needs only the source checkout; builds and SDK downloads stay in CI.
