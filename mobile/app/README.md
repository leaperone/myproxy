...
The mobile app uses Expo SDK 57.0.24, React Native 0.86.3 and React 19.2.3. Expo's SDK 57 bare template pins React Native 0.86.3; this avoids relying on React Native 0.87 internals that Expo's Metro integration does not support. The repository does not commit a lockfile from a developer machine. CI installs the exact dependency graph and builds the iOS/Android artifacts remotely.
